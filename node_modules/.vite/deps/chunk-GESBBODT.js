...
function useMenu(parameters = {}) {
  ...
  const subitemKeys = React2.useMemo(() => Array.from(subitems.keys()), [subitems]);
  ...
  const reducerActionContext = React2.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
//# sourceMappingURL=chunk-GESBBODT.js.map
