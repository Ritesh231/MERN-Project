...
} from "./chunk-4CYNX7FG.js";
import {
  useOption,
  useOptionContextStabilizer
} from "./chunk-YZPBOZ6H.js";
import {
...
import {
  ...
  useInput
} from "./chunk-GOO4JDWH.js";
import {
  generateUtilityClass,
  generateUtilityClasses
} from "./chunk-IDGVN72V.js";
import {
  useButton
...
import {
  DropdownActionTypes,
  DropdownContext
} from "./chunk-DGIYA2HI.js";
import {
  useControllableReducer
} from "./chunk-4AOO2AUZ.js";
import {
  areArraysEqual,
...
function useTabs(parameters) {
  ...
  const onSelected = React11.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React11.useRef(() => void 0);
  const getTabPanelId = React11.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React11.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React11.useCallback((lookupFunction) => {
...
function useTabsContext() {
  const context = React12.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const tabsContextValue = React13.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
...
var Tabs = React14.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabsList(parameters) {
  ...
  const contextValue = React16.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useTab(parameters) {
  ...
  const tabRef = React18.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React18.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
true ? CssAnimation.propTypes = {
  ...
  enterAnimationName: import_prop_types23.default.string,
  enterClassName: import_prop_types23.default.string,
  exitAnimationName: import_prop_types23.default.string,
...
true ? CssTransition.propTypes = {
  ...
  lastTransitionedPropertyOnEnter: import_prop_types24.default.string,
  lastTransitionedPropertyOnExit: import_prop_types24.default.string
} : void 0;
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NWLJZXIW.js.map
